...
import { PreviewBadge } from '@/components/common/preview-badge';
...
export const metadata: Metadata = {
  ...
  category: 'shopping',
  // Em prévia não há canonical: apontar para um domínio que ainda não é este
  // site só confundiria quem inspecionar a página.
  alternates: isIndexable ? { canonical: '/' } : {},
  openGraph: {
    type: 'website',
    locale: seo.locale,
    url: brand.siteUrl,
